...
public class Function {
    ...
    /**
     * ƒанный метод принимает url страницу в виде стринг (responce), затем строка раздел€етс€ по \n,
     * затем записываетс€ в  новый лист, без учета закрытых тэгов ('/')
     */
    ...
    /**
     * ƒанный метод принимает List где указаны различные данные обьекта,
     * затем в цикле у данного объекта извлекаетс€ аватар и записываетс€ в новый List
     */
    ...
    /**
     * ƒанный метод принимает List где указаны различные данные обьекта,
     * затем в цикле у данного объекта извлекаетс€ аватар и записываетс€ в новый Set
     * (записываютс€ только уникальные аватары)
     */
    ...
    /**
     * ƒанный метод принимает List где указаны различные данные обьекта,
     * затем в цикле у данного объекта извлекаетс€ год и записываетс€ в новый List
     */
     ...
     * ƒанный метод принимает List где указаны различные данные обьекта,
     * затем в цикле у данного объекта извлекаетс€ год и записываетс€ в новый List,
     * полученный List сортируетс€ по возрастанию
     */
